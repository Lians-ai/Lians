...
import pytest
from lians import LiansMemoryHarness, LocalLiansClient, RecalledMemory, TurnResult
...
class TestCompliancePassthroughs:
    ...
    def test_erase_uses_default_subject(self):
        with LocalLiansClient() as mem:
            ...
            assert res["snapshot"]["memories"] >= 1
            # Durable erasure status never returns the raw subject identifier.
            assert "subject_id" not in res
