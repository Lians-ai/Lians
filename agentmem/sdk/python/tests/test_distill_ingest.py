...
def test_distill_stores_facts_and_raw_provenance(monkeypatch):
    # Distillation is implemented by the vendored service engine, not exposed
    # as a public SDK module.  Patch the same engine module LocalLiansClient
    # resolves in both a monorepo checkout and an installed wheel.
